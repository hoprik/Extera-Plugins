...
public class StatsFM extends Provider implements ITrackInfo, IReleaseInfo, IArtistInfo, IFindMusicInfo {
    ...
    @Override
    public void getTrackInfo(String id, ICallback<Track> callback) {
    ...
    @Override
    public void getArtistInfo(String id, ICallback<Artist> callback) {
    ...
    // --------------------------------------------------------------
    @Override
    public void getReleaseInfo(String id, ICallback<Release> callback) {
